...
def create_options_frame(container):
    ...
    if options == True:
        ...
        weeks_check.grid(column=2, row=1, sticky=tk.W)
        weeks_check = ttk.Radiobutton(
            frame,
            variable=weeks,
            text='2 weeks',
            value=2,
            command=option_changed_week(weeks.get()))
        weeks_check.grid(column=2, row=2, sticky=tk.W)
        weeks_check = ttk.Radiobutton(
            frame,
            variable=weeks,
            text='3 weeks',
            value=3,
            command=option_changed_week(weeks.get()))
        weeks_check.grid(column=2, row=3, sticky=tk.W)
        weeks_check = ttk.Radiobutton(
            frame,
            variable=weeks,
            text='4 weeks',
            value=4,
            command=option_changed_week(weeks.get()))
        weeks_check.grid(column=2, row=4, sticky=tk.W)
